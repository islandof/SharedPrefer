            ...
            if (mRowLayoutList != null)
            {
                ...
                switch ((Frameint + 1) % 6)
                {
                    ...
                    case 3:
                        ...
                        row.FindViewById<TextView>(Resource.Id.txtAla19).Text = mTestcase1s[position].Ala19;
                        row.FindViewById<TextView>(Resource.Id.txtAla20).Text = mTestcase1s[position].Ala20;
                        row.FindViewById<TextView>(Resource.Id.txtAla21).Text = mTestcase1s[position].Ala21;
                        break;
                    case 4:
                        row.FindViewById<TextView>(Resource.Id.txtchepaino).Text = mTestcase1s[position].chepaino;
                        row.FindViewById<TextView>(Resource.Id.txtAla30).Text = mTestcase1s[position].Ala30;
                        row.FindViewById<TextView>(Resource.Id.txtAla31).Text = mTestcase1s[position].Ala31;
                        row.FindViewById<TextView>(Resource.Id.txtAla32).Text = mTestcase1s[position].Ala32;
                        row.FindViewById<TextView>(Resource.Id.txtAla33).Text = mTestcase1s[position].Ala33;
                        break;
                    case 5:
                        row.FindViewById<TextView>(Resource.Id.txtchepaino).Text = mTestcase1s[position].chepaino;
                        row.FindViewById<TextView>(Resource.Id.txtAla34).Text = mTestcase1s[position].Ala34;
                        row.FindViewById<TextView>(Resource.Id.txtAla35).Text = mTestcase1s[position].Ala35;
                        row.FindViewById<TextView>(Resource.Id.txtAla36).Text ="";
                        row.FindViewById<TextView>(Resource.Id.txtAla37).Text = "";
                        break;
