...
namespace XamarinDemo.Maps
{
    ...
    [Activity(ConfigurationChanges = ConfigChanges.Orientation | ConfigChanges.KeyboardHidden,
        Label = "@string/demo_name_bus", ScreenOrientation = ScreenOrientation.Sensor)]
    ...
    {
        private IList<string> busLineIDList;
        ...
        public void OnGetBusLineResult(BusLineResult result)
        {
            ...
            route = result;
            nodeIndex = -1;
            var overlay = new BusLineOverlay(mBaiduMap);
        ...
        public void SearchNextBusline(View v)
        {
                ...
                && busLineIDList.Count > 0)
            {
                mBusLineSearch.SearchBusLine((new BusLineSearchOption()
                    .City((FindViewById<EditText>(Resource.Id.city)).Text).Uid(busLineIDList[busLineIndex])));
        ...
        public void NodeClick(View v)
        {
            ...
            View viewCache = LayoutInflater.Inflate(Resource.Layout.custom_text_view,
                null);
            var popupText = viewCache.FindViewById<TextView>(Resource.Id.textcache);
            // 上一个节点
