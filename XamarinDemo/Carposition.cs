...
namespace XamarinDemo
{
     ...
     * 演示覆盖物的用法
     */
	[Activity (ConfigurationChanges = ConfigChanges.Orientation | ConfigChanges.KeyboardHidden, Label = "@string/monitor_name_carposition", ScreenOrientation = ScreenOrientation.Sensor)]
	public class Carposition: Activity
	{
        ...
        */
		...
		{
			public Carposition overlayDemo;

			public IOnMarkerClickListenerImpl (Carposition overlayDemo)
			{
