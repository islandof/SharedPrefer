...
{
    internal class Testcase3sAdapter : BaseAdapter<testCase3>
    {
        private readonly Context mContext;
        private readonly int mLayout;
        private readonly List<testCase3> mtestCase3s;
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            row.FindViewById<TextView>(Resource.Id.txtName).Text = mtestCase3s[position].ownercompanyname + ":" +
                                                                   mtestCase3s[position].sijiname;
