...
{
    [Activity(Label = "时间栅栏列表")]
    public class ZhalantimeList : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Resource.Layout.ZhalantimeList);
            ...
            mUrl = new Uri("http://cloud.tescar.cn/Vehicle/GetZhalantimeData?isspec=1");
        ...
        private void mClient_DownloadDataCompleted(object sender, DownloadDataCompletedEventArgs e)
        {
            RunOnUiThread(() =>
            {
                try
                {
                    ...
                    mAdapter = new Testcase789sAdapter(this, Resource.Layout.row_testcase3, mDataList, 7);
        ...
        private void mSearch_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (mDataList != null)
            {
                ...
                mAdapter = new Testcase789sAdapter(this, Resource.Layout.row_testcase, searchedData, 7);
                mListView.Adapter = mAdapter;
            }
        }
