...
namespace XamarinDemo
{
    ...
    public class AreaDetail : Activity
    {
        /**
        * MapView 是地图主控件
        */
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            mItem = JsonConvert.DeserializeObject<testCase5>(Intent.GetStringExtra("area"));
            InitOverlay(mItem);
        ...
        public void InitOverlay(testCase5 data)
        {
            try
            {
        ...
        {
            public readonly AreaDetail overlayDemo;

            public IOnMarkerClickListenerImpl(AreaDetail overlayDemo)
            {
