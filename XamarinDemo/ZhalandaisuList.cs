...
{
    [Activity(Label = "怠速栅栏列表")]
    public class ZhalandaisuList : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Resource.Layout.ZhalandaisuList);
            ...
            mUrl = new Uri("http://cloud.tescar.cn/Vehicle/GetZhalandaisuData?isspec=1");
        ...
        private void mClient_DownloadDataCompleted(object sender, DownloadDataCompletedEventArgs e)
        {
            RunOnUiThread(() =>
            {
                try
                {
                    ...
                    mAdapter = new Testcase789sAdapter(this, Resource.Layout.row_testcase3, mDataList, 9);
        ...
        private void mSearch_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (mDataList != null)
            {
                ...
                mAdapter = new Testcase789sAdapter(this, Resource.Layout.row_testcase, searchedData, 9);
                mListView.Adapter = mAdapter;
            }
        }
